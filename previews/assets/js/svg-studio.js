...
function getText(key, params = {}) {
    ...
    const langData = i18nData[currentLanguage] || i18nData[fallbackLang] || {};
    let text = (langData && langData[key]) || (i18nData[fallbackLang] && i18nData[fallbackLang][key]) || key;
...
function switchLanguage(lang) {
    const fallbackLang = 'zh-CN';
    const targetLang = i18nData[lang] ? lang : fallbackLang;
    currentLanguage = targetLang;
    localStorage.setItem('svgstudio_language', targetLang);
    updateAllTexts();
    updatePageTitle();
